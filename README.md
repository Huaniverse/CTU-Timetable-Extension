...
Vì đây là bản phát triển chưa được tải lên Chrome Web Store, bạn sẽ cần cài đặt thủ công thông qua chế độ dành cho nhà phát triển (Developer mode). Chỉ cần làm một lần duy nhất:
